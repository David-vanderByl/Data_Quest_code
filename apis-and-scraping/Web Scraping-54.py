...
with open("scraping_data.json", 'r') as f:
    data = json.load(f)
requests.register_all(data)
...
print("Total plays by the Patriots: ", patriots_total_plays_count)

seahawks_total_yards_count = parser.select("#total-yards td")[1].text
print("Total yards by the Seahawks: ", seahawks_total_yards_count)