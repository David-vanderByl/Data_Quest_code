...
for file in data_files:
    ...
    # formating file path string for reading
    file_path = 'schools/{}'.format(file)
    
    # removing .csv from file name to use as dict key
    key = file.replace('.csv', '')
 
    
    # reading csv as pandas df and storing in data dict
