...
print(taxi_modified[:, 6] )

bool_2 = taxi_modified[:, 6] == 2  
taxi_modified[bool_2, 15] = 1

bool_3 = taxi_modified[:, 6] == 3
taxi_modified[bool_3, 15] = 1

bool_5 = taxi_modified[:, 6] == 5
taxi_modified[bool_5, 15] = 1
